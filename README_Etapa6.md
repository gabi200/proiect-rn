...
|----------|------------------------------------------|--------------|--------------|-------------------|----------------|
| Baseline | Configurația din Etapa 5 | 0.917| 0.83 | 331 min (5.5 ore) | Referință |
| 1 | Schimbare `cls=2.0` | X | X | X |X |
| 2 | Schimbare `cls=2.0, label_smoothing=0.1` | X | X | X |X |
| 3 | Schimbare `cls=2.0, label_smoothing=0.1, close_mosaic=10` | X | X | X |X |
| 4 | Schimbare `cls=2.0, label_smoothing=0.1, close_mosaic=10, copy_paste=0.3` | X | X | X |X |
